    ...
    event.respondWith(
      (async () => {
        try {
          ...
          const cache = await caches.open(CACHE_NAME);
          cache.put('./cv.html', networkRes.clone());
          return networkRes;
        } catch (e) {
